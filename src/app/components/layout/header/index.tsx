                        ...
                        <div className="relative flex align-middle">
                            {pathname === "/shop" ? (
                                <Link href="/cart" className="flex items-center justify-center relative">
                                    <Icon icon="mdi:cart" width={40} height={40} className="text-secondary dark:text-white hover:text-primary transition" />
                                    {cart.length > 0 && (
                                        <span className="absolute -top-2 -right-2 bg-red-600 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center border-2 border-white dark:border-twilliteblack">
